...
const footerStartIndex = base.indexOf('<footer class="footer"'); // removed the > so it matches
...
const sobreHTML = `
  ...
  <section class="section" style="padding-top: 80px;">
    <div class="container">
      ...
      <!-- CTA -->
      <div class="cta-block" style="margin-bottom: 40px;">
...
console.log("Pages fixed correctly this time!");
